...
import { ComponentInternalInstance, computed, getCurrentInstance, nextTick, onBeforeUnmount, ref } from '@vue/runtime-core';
...
function clickMenuItem(item: IClickMenuItem) {
    ...
    status.value = false
    item.action && item.action(props.el, props.axis, props.menus, props.isDark)
